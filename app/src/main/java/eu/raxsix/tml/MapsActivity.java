...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, GpsStatus.Listener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
                ...
                if (networkInfo != null && networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                    Log.d(TAG, "We got internet");

                    if (mSocket != null && !mSocket.connected()) {
                        //Log.d(TAG, "Socket is NOT null and socket is NOT connected, lets connect it again");
                        connectSocket();
                    }

                    if (mSocket != null && mSocket.connected() && !mUsersHasMap.isEmpty()) {
                        //Log.d(TAG, "Socket is NOT null and socket is  connected, start location");
                    ...
                    Log.d(TAG, "Turning event listeners off");
                    turnEventsOff();
                    ...
                    Log.d(TAG, "Clearing the userList");
    ...
    protected void onResume() {
        ...
        if (isInit) {
            if (mSocket != null) {
                Log.d(TAG, "onResume - turn on onPosition listener");
    ...
    protected void onStop() {
        ...
        if (mSocket != null) {
            Log.d(TAG, "onResume - turn off onPosition listener");
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            if (mSocket == null) {
                Log.d(TAG, "onServiceConnected -connectSocket");
                connectSocket();
            }
    ...
    private void connectSocket() {
        ...
        if (mGoogleApiClient != null) {
            Log.d(TAG, "set googleApiClient to service");
    ...
    protected void startLocationUpdates() {
        ...
        Log.d(TAG, "startLocationUpdates is called");
    ...
    protected void stopLocationUpdates() {
        ...
        Log.d(TAG, "stopLocationUpdates is called");
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.d(TAG, "Location update called" + " is connected: " + mSocket.connected());

        if (mSocket != null && !mSocket.connected()) {
            Log.d(TAG, "Socket is NOT null and socket is NOT connected, stop location update");
            if (mGoogleApiClient != null && mGoogleApiClient.isConnected()) {
                stopLocationUpdates();
            }
        }
...
//        }
    ...
    private void removeUserFromHashMap(String userID) {
        ...
        Log.d(TAG, "removeUserFromHashMap");
